...
- 第一輪 server training validation ROI 為正，但 2026-05-09 holdout WIN ROI 為負，原因係候選仍接近場場下注；已把黑箱搜尋改成更保守，擴大最低 EV / 最低勝率 / 最低賠率範圍，並在 objective 加入 selectivity 與更重 drawdown penalty。
