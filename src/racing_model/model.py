...
FEATURE_LABELS_ZH.update(
    {
        ...
        "early_speed_profile": "起步速度",
        "midrace_move_score": "中段推進",
        "projected_position_score": "預計位置",
        "traffic_risk_score": "塞車風險",
        "pace_advantage_score": "步速優勢",
        "distance_pace_fit": "路程步速配合",
        "class_change_signal": "升降班訊號",
        "rating_change_signal": "評分變化",
        "hidden_ability_signal": "隱藏能力",
        "pedigree_distance_fit": "血統路程適性",
        "pedigree_surface_fit": "血統場地適性",
        "pedigree_novelty_risk": "血統新鮮風險",
            ...
            rows.append(
                {
                    ...
                    "early_speed_profile": runner.features.get("early_speed_profile", 0.0),
                    "midrace_move_score": runner.features.get("midrace_move_score", 0.0),
                    "projected_position_score": runner.features.get("projected_position_score", 0.0),
                    "traffic_risk_score": runner.features.get("traffic_risk_score", 0.0),
                    "pace_advantage_score": runner.features.get("pace_advantage_score", 0.0),
                    "distance_pace_fit": runner.features.get("distance_pace_fit", 0.0),
                    "class_change_signal": runner.features.get("class_change_signal", 0.0),
                    "rating_change_signal": runner.features.get("rating_change_signal", 0.0),
                    "hidden_ability_signal": runner.features.get("hidden_ability_signal", 0.0),
                    "pedigree_distance_fit": runner.features.get("pedigree_distance_fit", 0.0),
                    "pedigree_surface_fit": runner.features.get("pedigree_surface_fit", 0.0),
                    "pedigree_novelty_risk": runner.features.get("pedigree_novelty_risk", 0.0),
